    ...
    generateCode(codegen) {
        ...
        if (isNestedTag) {
            ...
            if (hasBody && context.isServerTarget() && !parentCustomTag.isFlagSet(HAS_RENDER_BODY_PROP_ADDED)) {
                ...
                var hasRenderBodyKey = context.addStaticVar('hasRenderBodyKey', builder.functionCall(builder.memberExpression(builder.identifier('Symbol'), builder.identifier('for')), [builder.literal('hasRenderBody')]));
