...
var morphAttrs = require('../runtime/vdom/VElement').a__;
...
function compareNodeNames(fromEl, toEl) {
    return fromEl.nodeName === toEl.aa_;
}
    ...
    function morphEl(fromEl, toEl, childrenOnly) {
        ...
        if (nodeName !== 'TEXTAREA') {
            ...
            outer: while (curToNodeChild) {
                toNextSibling = curToNodeChild._b_;
                                ...
                                if (curToNodeKey !== curFromNodeKey) {
                                    ...
                                    if (matchingFromEl = getElementById(doc, curToNodeKey)) {
                                        if (curFromNodeChild.nextSibling === matchingFromEl) {
                                            ...
                                            var curToNodeChildNextSibling = curToNodeChild._b_;
