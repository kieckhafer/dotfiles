...
var resolveComponentKey = modernRenderer._T_;
var preserveComponentEls = modernRenderer._U_;
var handleBeginAsync = modernRenderer._V_;
...
function createRendererFunc(templateRenderFunc, componentProps) {
    ...
    return function renderer(input, out, renderingLogic) {
        ...
        var componentDef = componentsContext._D_(component || fakeComponent);
