var getElementById = require('../util').e_;

module.exports = function render(input, out) {
    var globalComponentsContext = out.global._A_;

    if (globalComponentsContext && globalComponentsContext.Z_ !== true && globalComponentsContext.Y_ !== undefined) {
        var id = input.id;
        ...
        if (!('if' in input) || input['if']) {
            var existingEl = getElementById(out.F_, id);
            if (existingEl) {
                ...
                globalComponentsContext._B_(id, bodyOnly);
                return;
            }
        }
    }
