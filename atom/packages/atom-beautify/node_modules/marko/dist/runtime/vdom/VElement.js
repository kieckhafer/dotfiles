...
function VElement(tagName, attrs, childCount, flags, props) {
    ...
    this.aQ_ = attrs || EMPTY_OBJECT;
    this.aR_ = props || EMPTY_OBJECT;
    this.aS_ = namespaceURI;
    this.aa_ = tagName;
    this.aT_ = null;
    this.ad_ = constId;
}
...
VElement.prototype = {
    ...
    e: function (tagName, attrs, childCount, flags, props) {
        var child = this.aD_(new VElement(tagName, attrs, childCount, flags, props));
    ...
    ed: function (tagName, attrs, childCount, flags, props) {
        var child = this.aD_(VElement.aF_(tagName, attrs, childCount, flags, props));
    ...
    ab_: function (doc) {
        var namespaceURI = this.aS_;
        var tagName = this.aa_;

        var attributes = this.aQ_;
        var flags = this.ax_;
...
defineProperty(proto, 'value', {
    get: function () {
        var value = this.aT_;
        if (value == null) {
            value = this.aQ_.value;
        }
        return value != null ? toString(value) : '';
    }
});

defineProperty(proto, 'aV_', {
    get: function () {
        return this.ax_ & FLAG_IS_TEXTAREA;
    }
});

VElement.aF_ = function (tagName, attrs, childCount, flags, props) {
    ...
    element.aS_ = namespace;
    return element;
};

VElement.aW_ = function (attrs) {
...
VElement.a__ = function (fromEl, toEl) {

    var removePreservedAttributes = VElement.aW_;

    var attrs = toEl.aQ_;
    var props = fromEl._vprops = toEl.aR_;
